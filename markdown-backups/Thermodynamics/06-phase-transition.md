...
chapter: 6
readTime: 50
description: "理想气体走到尽头——把分子间作用力请回来，就打开了真实物质的世界：范德瓦尔斯方程、临界点、相变、相图、克拉珀龙方程，以及固体热容与液体表面张力。这是宏观与微观的合流。含五张配图与例题精讲。"
---
...
> [图片 06-01：Lennard-Jones 势能曲线。近距（r<r₀）强排斥（电子云重叠），远距（r>r₀）吸引（van der Waals 力），平衡距离 r₀ 处势能最低、F=0；势阱深度为 ε。]
...
> [图片 06-02：范德瓦尔斯等温线。高温（T>Tc）形如理想气体单调下降；低温（T<Tc）出现 S 形振荡（对应气液共存）；恰在临界温度 Tc 时 S 形缩成一个拐点（临界点）。]
...
> [图片 06-03：p-T 相图。固、液、气三个区域由熔化曲线、汽化曲线、升华曲线分隔，三线交于三相点；汽化曲线终止于临界点，越过它气液不可区分。]
...
> [图片 06-05：固体摩尔热容随温度变化。高温趋于 Dulong-Petit 极限 3R，低温则一路趋于零（C_V→0 as T→0）——经典能量均分解释不了低温下降，需要量子模型。]
...
> [图片 06-04：液体表面张力。内部分子四周受力平衡（合力为零），表面分子只有内侧有邻居、受净向内的力，使表面趋于收缩；由此球形液滴内外有附加压强 Δp=2σ/R（拉普拉斯）。]
