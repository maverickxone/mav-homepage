---
title: "第一章：存储的秘密——文件都去哪了？"
chapter: 2
readTime: 40
description: "解释硬盘、内存、缓存、文件系统和删除文件背后的真实机制，澄清存储容量、速度与数据保存之间的关系。"
---
